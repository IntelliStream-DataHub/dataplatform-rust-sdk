...
class SubscriptionListener:
    ...
    # Seconds; defaults to 30. Raises TimeoutError when it expires — the listener stays usable.
    # None waits indefinitely, which only ends when the stream does.
    def next_message(self, timeout: float | None = 30.0) -> SubscriptionMessage | None: ...
...
class SubscriptionListenerAsync:
    ...
    # Seconds; defaults to 30. Raises TimeoutError when it expires. None waits indefinitely.
    async def next_message(self, timeout: float | None = 30.0) -> SubscriptionMessage | None: ...
