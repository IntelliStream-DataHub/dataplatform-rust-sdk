...
import builtins
import datetime
from typing import Any, ClassVar, Iterable, Iterator, Mapping, Optional, Sequence, Union
...
class Page(Sequence[Any]):
    ...
    @property
    def items(self) -> builtins.list[Any]: ...
    @property
...
class DataHubException(Exception):
    ...
    problem document — a proxy's empty 502, a stack trace, or plain text.
    """
    status_code: int
    message: str
    problem: dict | None
...
class DataHubClient:
    def __init__(
        ...
        `openid` is always requested; `scope` (env: SCOPE) adds to it, and `audience`
        (env: AUDIENCE) is sent only when set. Against a DataHub realm using Keycloak
        Organizations, `scope` is required: use `organization:*`, or `organization:<alias>` to pin
        one tenant. That claim comes from a dynamic client scope, so without a selector the token
        carries no tenant and every call fails `401 invalid_token`. Not needed where the realm
        produces the `organization` claim with a protocol mapper. Entra ID's
        `api://<app-id-uri>/.default` belongs in `assertion_scope` instead, since Entra rejects it
        alongside `openid`; Auth0 requires an audience.
...
class ListFieldStr:
    @classmethod
    def set(cls, values: builtins.list[str]) -> ListFieldStr: ...
    @classmethod
    def delta(cls, add: builtins.list[str] | None = None, remove: builtins.list[str] | None = None) -> ListFieldStr: ...


# Entries name a resource by id, external_id, or both; `remove` matches on whichever side is given.
class ListFieldIdCollection:
    @classmethod
    def set(cls, values: builtins.list[IdCollection]) -> ListFieldIdCollection: ...
    @classmethod
    def delta(
        cls,
        add: builtins.list[IdCollection] | None = None,
        remove: builtins.list[IdCollection] | None = None,
...
class MapField:
    ...
    @classmethod
    def delta(cls, add: dict[str, str] | None = None, remove: builtins.list[str] | None = None) -> MapField: ...
...
class TimeSeries:
    def __init__(
        ...
        related_resources: builtins.list[RelatedNode] | None = None,
        source: str | None = None,
    ) -> None:
        """Either ``name`` or ``external_id`` is required: a missing ``external_id`` is derived
        from ``name`` in snake_case, a missing ``name`` copies ``external_id``. ``value_type``
        defaults to ``"bigint"`` — pass ``"float"`` for a series of decimal readings."""
    @staticmethod
    def from_dict(dict: dict[str, str]) -> TimeSeries: ...
    @property
    ...
    @property
    def labels(self) -> builtins.list[str] | None:
        """Always includes the intrinsic "TIMESERIES" type-label."""
    @labels.setter
    def labels(self, value: builtins.list[str] | None) -> None: ...
    @property
    def id(self) -> int | None: ...
    @property
    ...
    @property
    def related_resources(self) -> builtins.list[RelatedNode]: ...
    @related_resources.setter
    def related_resources(self, value: builtins.list[RelatedNode] | None) -> None: ...
    @property
    ...
    def related_events(self, limit: int = 100) -> builtins.list[Event]: ...
    async def related_events_async(self, limit: int = 100) -> builtins.list[Event]: ...
...
class DatapointsCollectionString:
    def __init__(self, datapoints: builtins.list[DatapointString], ts: Identifiable) -> None: ...

class DatapointsCollectionDatapoints:
    def get_datapoints(self) -> builtins.list[Datapoint]: ...
...
class RetrieveFilter:
    def __init__(
        ...
        limit: int | None = None,
        aggregates: builtins.list[str] | None = None,
    ...
    @property
    def aggregates(self) -> builtins.list[str] | None: ...
    @property
...
class TimeSeriesServiceSync:
    ...
    def by_ids(self, input: builtins.list[Identifiable]) -> builtins.list[TimeSeries]: ...
    def delete(self, input: builtins.list[Identifiable]) -> None: ...
    ...
    def retrieve_latest_datapoints(
        self, input: builtins.list[Identifiable]
...
class TimeSeriesServiceAsync:
    ...
    async def by_ids(self, input: builtins.list[Identifiable]) -> builtins.list[TimeSeries]: ...
    async def delete(self, input: builtins.list[Identifiable]) -> None: ...
...
class Event:
    def __init__(
        ...
        data_set_id: int | None = None,
        related_resources: builtins.list[IdCollection] | None = None,
        source: str | None = None,
    ) -> None:
    ...
    @property
    def related_resources(self) -> builtins.list[IdCollection]: ...
    @related_resources.setter
    def related_resources(self, value: builtins.list[IdCollection]) -> None: ...
    @property
    ...
    def related_resource_nodes(self) -> builtins.list[Node]: ...
    async def related_resource_nodes_async(self) -> builtins.list[Node]: ...
...
class EventsServiceSync:
    ...
    def by_ids(self, input: builtins.list[EventIdentifiable]) -> builtins.list[Event]: ...
    def get(self, id: UUID) -> Event | None: ...
    def delete(self, input: builtins.list[EventIdentifiable]) -> None: ...
...
class EventsServiceAsync:
    ...
    async def by_ids(self, input: builtins.list[EventIdentifiable]) -> builtins.list[Event]: ...
    async def get(self, id: UUID) -> Event | None: ...
    async def delete(self, input: builtins.list[EventIdentifiable]) -> None: ...
...
class Dataset:
    def __init__(
        ...
        id: int | None = None,
        description: str | None = None,
        policies: builtins.list[str] | None = None,
        metadata: dict[str, str] | None = None,
        connected_data_sets: builtins.list[int] | None = None,
    ) -> None: ...
    @property
    def node_type(self) -> str:
        """This node's type as a string ("asset", "timeseries", "function", "resource",
    ...
    def description(self, value: str | None) -> None: ...
    @property
    def policies(self) -> builtins.list[str] | None: ...
    @policies.setter
    def policies(self, value: builtins.list[str] | None) -> None: ...
    @property
    def metadata(self) -> dict[str, str]: ...
    @metadata.setter
    def metadata(self, value: dict[str, str]) -> None: ...
    @property
    def connected_data_sets(self) -> builtins.list[int]: ...
    @connected_data_sets.setter
    def connected_data_sets(self, value: builtins.list[int]) -> None: ...
...
# `search(query, ...)`: query is 3-140 characters. Hits are ranked by relevance.
#
...
class DatasetsServiceSync:
    ...
    def by_ids(self, input: builtins.list[Identifiable]) -> builtins.list[Dataset]: ...
    def delete(self, input: builtins.list[Identifiable]) -> None: ...
    def filter(
        self,
...
class DatasetsServiceAsync:
    ...
    async def by_ids(self, input: builtins.list[Identifiable]) -> builtins.list[Dataset]: ...
    async def delete(self, input: builtins.list[Identifiable]) -> None: ...
    async def filter(
        self,
        filter: DatasetFilter | None = None,
...
class ResourceNetwork:
    ...
    @property
    def edges(self) -> builtins.list[EdgeProxy]: ...
    @property
    def labels(self) -> builtins.list[Label]: ...
...
class GraphResult:
    ...
    def nodes(self) -> builtins.list[Node]: ...
    @property
    def relations(self) -> builtins.list[EdgeProxy]: ...
...
class ResourcesServiceSync:
    def list(self, limit: int | None = None) -> builtins.list[Node]: ...
    def create(
        self, nodes: builtins.list[Node], relations: builtins.list[RelForm] | None = None
    ) -> GraphResult: ...
    def by_ids(self, input: builtins.list[ResourceIdentifiable]) -> builtins.list[Node]: ...
    def delete(self, input: builtins.list[ResourceIdentifiable]) -> None: ...
    def search(
        self,
        query: str,
    ...
    def fetch_nearest(
        self,
        id: int,
        end_labels: builtins.list[str] | None = None,
        limit: int | None = None,
        relationship_types: builtins.list[str] | None = None,
        excluded_labels: builtins.list[str] | None = None,
    ) -> ResourceNetwork:
        """The closest ``limit`` nodes carrying one of ``end_labels``, plus the sub-graph
        connecting them back to the start. Starts from a numeric ``id`` only."""
    def filter(
        self,
        filter: ResourceFilter | None = None,
        id: Sequence[int] | None = None,
...
class ResourcesServiceAsync:
    async def list(self, limit: int | None = None) -> builtins.list[Node]: ...
    async def create(
        self, nodes: builtins.list[Node], relations: builtins.list[RelForm] | None = None
    ) -> GraphResult: ...
    async def by_ids(self, input: builtins.list[ResourceIdentifiable]) -> builtins.list[Node]: ...
    async def delete(self, input: builtins.list[ResourceIdentifiable]) -> None: ...
    async def search(
        self,
        query: str,
        filter: ResourceFilter | None = None,
    ...
    async def fetch_nearest(
        ...
        """Async twin of ``ResourcesServiceSync.fetch_nearest``."""
    async def filter(
        self,
        filter: ResourceFilter | None = None,
        id: Sequence[int] | None = None,
...
class LabelsServiceSync:
    ...
    def delete(self, input: builtins.list[LabelIdentifiable]) -> None: ...
...
class LabelsServiceAsync:
    ...
    async def delete(self, input: builtins.list[LabelIdentifiable]) -> None: ...
...
class Unit:
    ...
    @property
    def alias_names(self) -> builtins.list[str]: ...
    @alias_names.setter
    def alias_names(self, value: builtins.list[str]) -> None: ...
    @property
...
class INode:
    def __init__(
        ...
        data_set_id: int | None = None,
        metadata: dict[str, str] | None = None,
        related_resources: builtins.list[int] | None = None,
        security_categories: builtins.list[int] | None = None,
    ) -> None: ...
    @property
    def id(self) -> int | None: ...
    @property
    ...
    def metadata(self) -> dict[str, str] | None: ...
    @property
    def related_resources(self) -> builtins.list[int] | None: ...
    @property
    def security_categories(self) -> builtins.list[int] | None: ...
...
class FilesServiceSync:
    def upload_file(self, file_upload: FileUpload) -> builtins.list[INode]: ...
    def list_root_directory(self) -> builtins.list[INode]: ...
    def delete(self, input: builtins.list[FileIdentifiable]) -> None: ...
    def list_directory_by_path(self, path: str) -> builtins.list[INode]: ...
    def get_by_id(self, id: int) -> builtins.list[INode]: ...
    def get_by_external_id(self, external_id: str) -> builtins.list[INode]: ...
    def search(self, query: str) -> builtins.list[INode]: ...
    def list_trash(self) -> builtins.list[INode]: ...
    def restore(self, input: builtins.list[FileIdentifiable]) -> builtins.list[INode]: ...
    def update(self, update: FileUpdate) -> builtins.list[INode]: ...
    def download(self, id: int) -> FileDownload: ...
    def download_to_path(self, id: int, destination: str) -> int: ...


class FilesServiceAsync:
    async def upload_file(self, file_upload: FileUpload) -> builtins.list[INode]: ...
    async def list_root_directory(self) -> builtins.list[INode]: ...
    async def delete(self, input: builtins.list[FileIdentifiable]) -> None: ...
    async def list_directory_by_path(self, path: str) -> builtins.list[INode]: ...
    async def get_by_id(self, id: int) -> builtins.list[INode]: ...
    async def get_by_external_id(self, external_id: str) -> builtins.list[INode]: ...
    async def search(self, query: str) -> builtins.list[INode]: ...
    async def list_trash(self) -> builtins.list[INode]: ...
    async def restore(self, input: builtins.list[FileIdentifiable]) -> builtins.list[INode]: ...
    async def update(self, update: FileUpdate) -> builtins.list[INode]: ...
...
class Subscription:
    def __init__(
        ...
        external_id: str,
        name: str,
        timeseries: builtins.list[Identifiable],
    ) -> None: ...
    @property
    def id(self) -> int | None: ...
    @property
    ...
    def name(self) -> str: ...
    @property
    def timeseries(self) -> builtins.list[IdCollection]: ...
    @property
...
class SubscriptionFilter:
    def __init__(self, timeseries: builtins.list[SubscriptionTimeseriesId] | None = None) -> None: ...
    @property
    def timeseries(self) -> builtins.list[IdCollection]: ...
...
class DataSort:
    def __init__(
        self,
        property: builtins.list[str] | None = None,
        order: str | None = None,
        nulls: str | None = None,
    ) -> None: ...
    @builtins.property
    def property(self) -> builtins.list[str] | None: ...
    @builtins.property
...
class EventAction:
    Create: ClassVar[EventAction]
    Update: ClassVar[EventAction]
    Delete: ClassVar[EventAction]
    Rename: ClassVar[EventAction]
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...


class EventObject:
    Label: ClassVar[EventObject]
    Relation: ClassVar[EventObject]
    Resource: ClassVar[EventObject]
    Timeseries: ClassVar[EventObject]
    Function: ClassVar[EventObject]
    Event: ClassVar[EventObject]
    Datapoints: ClassVar[EventObject]
    ResourceAndRelation: ClassVar[EventObject]
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
...
class DataCollectionString:
    ...
    @property
    def datapoints(self) -> builtins.list[WsDatapoint]: ...
...
class DataWrapperMessage:
    ...
    @property
    def items(self) -> builtins.list[DataCollectionString]: ...
...
class SubscriptionListener:
    ...
    def ack(self, message_ids: builtins.list[str]) -> None: ...
    def nack(self, message_ids: builtins.list[str]) -> None: ...
    def subscribe(self, external_ids: builtins.list[str]) -> None: ...
    def unsubscribe(self, external_ids: builtins.list[str]) -> None: ...
    def set_subscriptions(self, external_ids: builtins.list[str]) -> None: ...
    def close(self) -> None: ...
...
class SubscriptionListenerAsync:
    ...
    async def ack(self, message_ids: builtins.list[str]) -> None: ...
    async def nack(self, message_ids: builtins.list[str]) -> None: ...
    async def subscribe(self, external_ids: builtins.list[str]) -> None: ...
    async def unsubscribe(self, external_ids: builtins.list[str]) -> None: ...
    async def set_subscriptions(self, external_ids: builtins.list[str]) -> None: ...
...
class SubscriptionsServiceSync:
    ...
    def filter(
        ...
        *,
        timeseries: builtins.list[SubscriptionTimeseriesId] | None = None,
        limit: int | None = None,
        sort: DataSort | None = None,
    ) -> builtins.list[Subscription]: ...
    def delete(self, input: builtins.list[SubscriptionIdentifiable]) -> None: ...
...
class SubscriptionsServiceAsync:
    ...
    async def delete(self, input: builtins.list[SubscriptionIdentifiable]) -> None: ...
...
class Function:
    ...
    def node_type(self) -> str:
        ...
        than with an isinstance ladder."""
    @property
    def labels(self) -> builtins.list[str]: ...
    @property
    def metadata(self) -> dict[str, str]: ...
    @property
    def description(self) -> str | None: ...
...
class FunctionsServiceSync:
    ...
    def by_ids(self, input: builtins.list[FunctionIdentifiable]) -> builtins.list[Function]: ...
    def by_external_id(self, external_id: str) -> Function: ...
    def delete(self, input: builtins.list[FunctionIdentifiable]) -> None: ...
...
class FunctionsServiceAsync:
    ...
    async def by_ids(self, input: builtins.list[FunctionIdentifiable]) -> builtins.list[Function]: ...
    async def by_external_id(self, external_id: str) -> Function: ...
    async def delete(self, input: builtins.list[FunctionIdentifiable]) -> None: ...
...
class EdgesServiceSync:
    ...
    def by_ids(self, input: builtins.list[EdgeIdentifiable]) -> GraphResult: ...
    def create(self, input: builtins.list[RelForm]) -> builtins.list[EdgeProxy]: ...
    def delete(self, input: builtins.list[EdgeIdentifiable]) -> None: ...
    def types(self) -> builtins.list[RelationshipType]: ...
    def create_types(self, input: builtins.list[RelTypeForm]) -> builtins.list[RelationshipType]: ...


class EdgesServiceAsync:
    async def get(self, id: int) -> EdgeProxy | None: ...
    async def by_ids(self, input: builtins.list[EdgeIdentifiable]) -> GraphResult: ...
    async def create(self, input: builtins.list[RelForm]) -> builtins.list[EdgeProxy]: ...
    async def delete(self, input: builtins.list[EdgeIdentifiable]) -> None: ...
    async def types(self) -> builtins.list[RelationshipType]: ...
    async def create_types(self, input: builtins.list[RelTypeForm]) -> builtins.list[RelationshipType]: ...
