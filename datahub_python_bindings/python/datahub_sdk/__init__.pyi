...
class EventsServiceSync:
    ...
    def count(self) -> int: ...
    def list_types(self, limit: int = 1000) -> list[str]: ...
    def list_sub_types(self, limit: int = 1000) -> list[str]: ...
    def list_statuses(self, limit: int = 1000) -> list[str]: ...
    def list_sources(self, limit: int = 1000) -> list[str]: ...
    def search_types(self, q: str, limit: int = 1000) -> list[str]: ...
    def search_sub_types(self, q: str, limit: int = 1000) -> list[str]: ...
    def search_statuses(self, q: str, limit: int = 1000) -> list[str]: ...
    def search_sources(self, q: str, limit: int = 1000) -> list[str]: ...
...
class EventsServiceAsync:
    ...
    async def list_types(self, limit: int = 1000) -> list[str]: ...
    async def list_sub_types(self, limit: int = 1000) -> list[str]: ...
    async def list_statuses(self, limit: int = 1000) -> list[str]: ...
    async def list_sources(self, limit: int = 1000) -> list[str]: ...
    async def search_types(self, q: str, limit: int = 1000) -> list[str]: ...
    async def search_sub_types(self, q: str, limit: int = 1000) -> list[str]: ...
    async def search_statuses(self, q: str, limit: int = 1000) -> list[str]: ...
    async def search_sources(self, q: str, limit: int = 1000) -> list[str]: ...
