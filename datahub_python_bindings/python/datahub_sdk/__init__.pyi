...
class DatapointInput:
    ...
    @classmethod
    def from_int(cls, ts: datetime.datetime, value: int) -> DatapointInput: ...
    @classmethod
    def from_float(cls, ts: datetime.datetime, value: float) -> DatapointInput: ...
    @property
...
class DatapointsBatch:
    """One timeseries' datapoints to insert. Pass a list of these to insert_datapoints;
    each element targets a distinct timeseries via its ``ts`` identifier."""
    def __init__(self, datapoints: list[DatapointInput], ts: Identifiable) -> None: ...


class DatapointsResult:
    """One timeseries' datapoints returned from a retrieve call (values and, when
    aggregates were requested, min/max/average/sum)."""
...
class TimeSeriesServiceSync:
    ...
    def insert_datapoints(self, input: list[DatapointsBatch]) -> list[str]: ...
...
class TimeSeriesServiceAsync:
    ...
    async def insert_datapoints(self, input: list[DatapointsBatch]) -> list[str]: ...
...
class Resource:
    ...
    @geolocation.setter
    def geolocation(self, value: dict[str, float] | None) -> None: ...
    @property
    def created_time(self) -> datetime.datetime | None: ...
    @property
    def last_updated_time(self) -> datetime.datetime | None: ...
